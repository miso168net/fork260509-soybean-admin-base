...
declare namespace App {
  ...
  namespace I18n {
    ...
    type Schema = {
      ...
      // （映射 wire msg key → 在地化；逐鍵鏡像 locale backend 樹 **38 鍵**＝003-auth-session
      // 之 22 鍵＋004-ip-trust-anchor 之 biz.ipRule.* 五鍵與 biz.throttle.* 一鍵＋
      // 005-role-menu-crud 之 biz.role.* 十鍵——各刀的單一權威＝該刀 contracts/msg-keys.md）。★必填（非 optional）＝en-us.ts／
