  ...
  backend: {
    ...
    biz: {
      ...
      user: {
        ...
        emailFormatInvalid: '該使用者的信箱格式不正確',
        emailTaken: '該信箱已被其他使用者使用',
      ...
      userCenter: {
        emailCaptchaInvalid: '圖形驗證碼錯誤或已過期，請重新驗證',
        emailFormatInvalid: '信箱格式不正確',
        emailTaken: '此信箱已被其他帳號使用',
        emailCooldown: '傳送過於頻繁，請於 {remainingSeconds} 秒後再試',
        emailDailyLimit: '今日傳送次數已達上限，請明日再試',
        emailSendFailed: '驗證信寄送失敗，請稍後再試',
        emailThrottleUnavailable: '系統暫時無法處理，請稍後再試',
        emailTokenInvalid: '驗證流程已失效，請重新傳送驗證碼',
        emailCodeExpired: '驗證碼已過期，請重新傳送',
        emailCodeAttemptsExceeded: '驗證碼錯誤次數過多，請重新傳送',
        emailCodeInvalid: '驗證碼錯誤，請重新輸入',
        emailNotBound: '尚未綁定信箱'
      }
